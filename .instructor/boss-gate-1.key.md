...
Update `SIGNATURE_SPELL` and `SEAL` below to match what you staged in `/scratch/shared/rf_bootcamp_2026/boss1/`.

---

## Staged files

- `/scratch/shared/rf_bootcamp_2026/boss1/` — ~50 standard spell files + 1 signature spell
