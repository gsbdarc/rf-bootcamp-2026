...
- Grimoire files for Day 1: run `python scripts/generate_grimoire.py --seed 2026 --count 300`, then `scp -r grimoire/ SUNetID@yen.stanford.edu:/scratch/rf_bootcamp_2026/grimoire/`
