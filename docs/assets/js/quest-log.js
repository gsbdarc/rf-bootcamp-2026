  ...
  const DAYS = [
    {
      ...
      prefix: 'd1',
      rooms: [
        { id: 'd1-command-spire',       keys: ['main', 'chest1', 'chest2', 'chest3'] },
        { id: 'd1-grimoire-vault',       keys: ['main', 'chest1', 'chest2', 'chest3'] },
        { id: 'd1-ssh-gate',             keys: ['main', 'chest1'] },
    ...
    },
    {
      ...
      prefix: 'd2',
      rooms: [
        { id: 'd2-venv-forge',           keys: ['main', 'chest1', 'chest2', 'chest3'] },
        { id: 'd2-path-labyrinth',       keys: ['main', 'chest1'] },
        { id: 'd2-key-vault',            keys: ['main', 'chest1', 'chest2'] },
        { id: 'd2-watchtower',           keys: ['main'] },
        { id: 'd2-ai-scribe',            keys: ['main', 'chest1', 'chest2'] },
        { id: 'd2-oracles-chamber',      keys: ['main', 'chest1', 'chest2', 'chest3'] },
        { id: 'd2-binding-room',         keys: ['main', 'chest1', 'chest2', 'chest3'] },
        { id: 'd2-ledger',               keys: ['main'] },
        { id: 'd2-persistence-chamber',  keys: ['main', 'chest1'] },
    ...
    },
    {
      ...
      rooms: [
        ...
        { id: 'd3-scales',               keys: ['main', 'chest1', 'chest2'] },
        { id: 'd3-foremans-desk',        keys: ['main', 'chest1', 'chest2'] },
        { id: 'd3-watch-tower',          keys: ['main', 'chest1'] },
        { id: 'd3-trap-room',            keys: ['main'] },
        { id: 'd3-array-cavern',         keys: ['main', 'chest1', 'chest2', 'chest3', 'chest4'] },
        { id: 'd3-chronicle',            keys: ['main', 'chest1', 'chest2'] },
